...
function [M1,C1,H1,G1]=get_3_frequency_dependence_input_parameter(Vp1,Vs1,dens1,Kf1,porous1,alpha1,Qp,Qs,model,omega)

          omega_ref = model.refer_omega;

          HG_temp1=(1/pi)*(log10(omega/omega_ref))+(1i/2);
 
          G_temp2=1+(1/Qs)*HG_temp1;
          H_temp2=1+(1/Qp)*HG_temp1;

          G1=Vs1*Vs1*G_temp2*G_temp2*dens1;
          H1=Vp1*Vp1*H_temp2*H_temp2*dens1;
