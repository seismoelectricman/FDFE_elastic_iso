...
%     set(gcf,'position',[100,100,1400,800])
   set(gcf,'position',[200,200,1010,460])
...
%           t_interval=t_interval+100;
          ...
          title(['(c) u_z (Time = ',num2str(t_interval*delt_t*1000),'ms) Oil']) 
          set(gca,'ytick',[0,400,800,1200,1600],'ydir','reverse')
          set(gca,'xtick',[-800,-400,0,400,800],'xdir','normal')
...
%         imagesc(x0,z0,uy_z_x,scale1);   hold on
          title(['(d) w_z (Time = ',num2str(t_interval*delt_t*1000),'ms) Oil']) 
%            
